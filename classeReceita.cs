...
namespace SistemaOptometrico
{
    public class ClasseReceita
    {
                ...
                using (PdfWriter writer = new PdfWriter(memoryStream))
                {
                    using (PdfDocument pdf = new PdfDocument(writer))
                    {
                        ...
                        using (Document document = new Document(pdf))
                        {
                            ...
                            // Adicionar célula com texto centralizado
        ...
        {
            string nomeCompleto = "Nome Teste"; // Substitua pelo valor real obtido do banco de dados
            DateTime dataDoExame = DateTime.Now; // Substitua pelo valor real obtido do banco de dados
